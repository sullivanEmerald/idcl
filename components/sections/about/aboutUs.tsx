    ...
    return (
        ...
        >
            ...
            >
                ...
                <motion.p
                    className="w-full font-satoshi font-light leading-[1.5] sm:leading-[1.3] lg:leading-[100%] tracking-[0em] text-[#000000] text-base sm:text-lg lg:text-[20px] text-center"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
