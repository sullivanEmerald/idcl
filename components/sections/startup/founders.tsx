...
export default function StartUpFounders() {
    return (
        <section className="w-[1200px] mx-auto flex py-[80px] flex-col gap-[54px] items-center justify-center">
            <header className="w-[620px] flex flex-col gap-[21px] items-center justify-center text-center">
                ...
                <span className="font-satoshi font-light text-[20px] leading-[1] tracking-[0em] text-[#000000] w-[653px] h-[27px] inline-block">Hear from Founders of startups, hatched from our incubator.</span>
            </header>
