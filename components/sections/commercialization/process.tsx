...
export default function CommercializationProcess() {
    return (
        <section className="w-full max-w-[1014px] flex flex-col gap-[50px] md:gap-[75px] items-center mx-auto py-[40px] md:py-[80px] px-4 sm:px-6 lg:px-0">
            <h1 className="text-[#3B3B3B] text-center font-satoshi font-bold text-[24px] sm:text-[28px] lg:text-[32px] leading-[26.4px] sm:leading-[30.8px] lg:leading-[35.2px]">
                Our Support Process
            </h1>
            <div className="w-full flex gap-x-[20px] sm:gap-x-[40px] lg:gap-x-[95px] gap-y-[60px] sm:gap-y-[80px] justify-center items-start flex-wrap">
                {TourProcess.map((item, index) => (
                    <div key={index} className="relative w-full sm:w-[280px] lg:w-[264px] flex-shrink-0">
                        <h1
