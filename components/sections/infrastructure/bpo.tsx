...
export default function InfrastructureBpo() {
    return (
        <section className="w-full max-w-[1001px] h-auto mx-auto flex flex-col-reverse lg:flex-row items-center justify-center gap-8 lg:gap-[72px] px-4 lg:px-0 py-8 lg:py-0">
