        ...
        md:items-start md:justify-start md:left-[80px] md:top-[180px] md:text-left lg:w-[895px]"
            >
                <motion.div
                    ...
                    className="font-satoshi font-black text-4xl sm:text-4xl md:text-6xl lg:text-[60px] leading-[1.1] tracking-[0.56px] text-white"
                >
                    <div className="whitespace-nowrap">IDCL News</div>
                    <div className="whitespace-nowrap capitalize">Be kept abrest with our news</div>
                </motion.div>
