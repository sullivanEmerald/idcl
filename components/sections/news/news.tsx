                ...
                <>
                    <div className="w-full sm:w-[1199px] py-[50px] mx-auto flex flex-col md:flex-row items-center justify-center gap-4 lg:gap-[33px]">
                        ...
                        <div className="space-y-[24px]">
                            ...
                            <article className="line-clamp-2 sm:line-clamp-3 md:line-clamp-10 font-satoshi text-[#061A2E] text-sm sm:text-m lg:text-[18px] leading-[27px] font-normal">{latest?.body}</article>
                        </div>
                    </div>
