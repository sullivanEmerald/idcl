...
export default function PreferencesSettings() {
  ...
  const updateUserPreferenceHandler =
    (handler: string) => async (checked: boolean) => {
      ...
      try {
        ...
        toast.success(
          checked
            ? `${handler} notification enabled`
            : `${handler} notification disabled`
        );
        console.log(data);
      } catch (error: unknown) {
        const responseError =
            ...
            <div className="space-y-4">
              <div className=" relative flex items-center justify-between">
                ...
                {isloading.isEmailNotificationEnabled ? (
                  ...
                  <Switch
                    checked={
                      UsernotificationPreferences.isEmailNotificationEnabled
                    }
              ...
              <div className=" relative flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Receive updates on your mobile phones
                  </p>
                </div>
                ...
                {isloading.isSmsNotificationEnabled ? (
                  ...
                  <Switch
                    checked={
                      UsernotificationPreferences.isSmsNotificationEnabled
                    }
              ...
              <div className="relative flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Receive campaign updates on your device
                  </p>
                </div>
                {isloading.isPushNotificationEnabled ? (
                  ...
                  <Switch
                    checked={
                      UsernotificationPreferences.isPushNotificationEnabled
                    }
