            ...
            <div className="w-full lg:flex-1">
              ...
              <div className="w-full sm:w-[578px] mx-auto bg-white p-2 rounded-md flex items-center justify-between mb-8">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[#FD650B] font-normal">Impressions</span>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  {promoterCampaigns
                    ...
                    .map((promoCampaign) => (
                      <div
                        ...
                        className="bg-white p-1 border border-gray rounded-lg cursor-pointer w-full h-[195px]"
                        onClick={() =>
                          router.push(`/c/${promoCampaign.id}?pId=${promoterId}`)
                        }
                      >
                        {/* Campaign image with elements overlaid on it */}
                        {promoCampaign.contentAssets?.length > 0 && (
                          <div className="relative aspect-video mb-3 w-full h-full">
                            <img
                              ...
                              <div className="h-8 bg-white flex items-center gap-4 px-3 rounded-md">
                                <div className="flex items-center gap-1">
                                  ...
                                  <span className="text-[12px] font-medium">
                                    {promoCampaign.metrics?.totalEngagements || 0}
                                  </span>
                                </div>
                                <div className="flex items-center gap-1">
                                  <svg
